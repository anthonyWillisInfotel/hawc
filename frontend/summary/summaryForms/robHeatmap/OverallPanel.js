...
class OverallPanel extends Component {
    render() {
        ...
        return (
            <div>
                <legend>Risk of bias heatmap settings</legend>
                ...
                />
                <ul>
                    <li>ADD Sort order</li>
                    <li>ADD Prefilter system</li>
                    <li>ADD Prefilter organ</li>
                    <li>ADD Prefilter effect</li>
                    <li>ADD Prefilter effect subtype</li>
                </ul>
            </div>
        );
    }
